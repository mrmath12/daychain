  ...
  return (
    <>
      <style>{`
        ...
        .wm-drift { animation: wmDrift 14s ease-in-out infinite; }
        ...
        /* ── Feature number scale on card hover ── */
        .feature-num {
          display: inline-block;
          transition: transform 0.2s cubic-bezier(0.16,1,0.3,1);
        }
        .group:hover .feature-num { transform: scale(1.08); }
        ...
        /* ── Hero gradient: dark default, light override ── */
        .hero-gradient {
          background: radial-gradient(ellipse 70% 55% at 50% 55%, #004152, #00181e 70%);
        }
        :root:not(.dark) .hero-gradient {
          background: radial-gradient(ellipse 70% 55% at 50% 55%, #b3e8f5 0%, hsl(192 100% 96%) 70%);
        }
        ...
        @media (prefers-reduced-motion: reduce) {
          ...
          .pulse-dot, .wm-drift { animation: none !important; }
          .feature-num, .btn-cta { transition: none !important; }
          .group:hover .feature-num, .btn-cta:hover, .btn-cta:active {
            transform: none !important;
          }
